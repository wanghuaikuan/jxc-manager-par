...
<head>
    ...
    <style>
        ...
        .login-main .login-bottom .tip .icon-check {margin:0 7px 0 0;width:14px;height:14px;border:none;background:url(${ctx.contextPath}/images/icon-login.png) no-repeat -111px -48px;}
        .login-main .login-bottom .center .item .icon {display:inline-block;width:33px;height:22px;}
        .login-main .login-bottom .center .item {width:288px;height:35px;border-bottom:1px solid #dae1e6;margin-bottom:35px;}
        .login-main {width:428px;position:relative;float:left;}
        .login-main .login-top {height:90px;background-color:#148be4;border-radius:12px 12px 0 0;font-family:SourceHanSansCN-Regular;font-size:30px;font-weight:400;font-stretch:normal;letter-spacing:0;color:#fff;line-height:117px;text-align:center;overflow:hidden;-webkit-transform:rotate(0);-moz-transform:rotate(0);-ms-transform:rotate(0);-o-transform:rotate(0);transform:rotate(0);}
        ...
        html {height:100%;}
        .login-main .login-bottom .tip {clear:both;height:16px;line-height:16px;width:288px;margin:0 auto;}
        .login-main .login-bottom .tip .login-tip {font-family:MicrosoftYaHei;font-size:14px;font-weight:400;font-stretch:normal;letter-spacing:0;color:black;cursor:pointer;}
        ...
        .login-main .login-bottom .tip .zhuce{color:#1391ff;text-decoration: none;position: absolute;right: 120px;font-stretch: normal }
        ...
        <form class="layui-form login-bottom" action="">
            <div class="center">
                <div class="item">
                    ...
                    <input type="text" name="username"   placeholder="请输入工位号" maxlength="24"/>
                </div>
...
<#--                    <span class="bind-password icon icon-4"></span>-->
           ...
           <div class="tip">
            ...
            <div class="layui-trans  layui-form-item layadmin-user-login-other" style="width:100%;height:100%;margin-top: 20px; margin-left: 66px; font-size: 14px">
                <label>社交账号登入</label>
                <a href="javascript:;"><i  style="font-size: 30px; color: #1E9FFF;" class="layui-icon layui-icon-login-qq"></i></a>
                <a href="javascript:;"><i style="font-size: 30px; color: #62b900;" class="layui-icon layui-icon-login-wechat"></i></a>
                <a href="javascript:;"><i  style="font-size: 30px; color: red;" class="layui-icon layui-icon-login-weibo"></i></a>
            </div>
        </form>
    </div>
</div>
