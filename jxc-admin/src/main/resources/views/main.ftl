    ...
    <div class="layui-header header">
        <div class="layui-logo" align="left">
            <a href="" >
                ...
                <h1 style="margin: 0 0 0 3px">在线营销系统
</h1>
            </a>
        </div>
        <a>
                ...
                <ul class="layui-nav layui-nav-tree layui-left-nav-tree layui-this" id="currency">
                    ...
                    <@security.authorize access="hasAnyAuthority('10')">
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                <@security.authorize access="hasAnyAuthority('1001')">
                                <dd>
                                    <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-11" data-tab="user/index" target="_self"><i class="fa fa-user"></i><span class="layui-left-nav"> 人员管理</span></a>
                                </dd>
                                </@security.authorize>
                                <@security.authorize access="hasAnyAuthority('1002')">
                                <dd class="">
                                ...
                                <@security.authorize access="hasAnyAuthority('1003')">
                                <dd class="">
